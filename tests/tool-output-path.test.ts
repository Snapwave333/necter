...
describe('extractFilePathFromToolOutput', () => {
  ...
  it('extracts absolute path from updated-file messages', () => {
    const output = 'The file /Users/haoqing/Library/Application Support/necter/default_working_dir/slide2.html has been updated successfully.';
    expect(extractFilePathFromToolOutput(output)).toBe('/Users/haoqing/Library/Application Support/necter/default_working_dir/slide2.html');
  });
  ...
  it('extracts screenshot path from wrapped screenshot output', () => {
    const output = JSON.stringify({
      content: [
        {
          type: 'text',
          text: 'Took a screenshot of the full current page.\nSaved screenshot to /Users/haoqing/Desktop/necter/agent_papers_summary_screenshot.png.',
        },
      ],
    });
    expect(extractFilePathFromToolOutput(output)).toBe('/Users/haoqing/Desktop/necter/agent_papers_summary_screenshot.png');
  });
