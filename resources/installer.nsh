!macro customCheckAppRunning
  ...
  nsExec::Exec 'taskkill /T /F /IM "Necter.exe"'
  Pop $R0
  ...
  nsExec::Exec 'powershell.exe -NoProfile -Command "Get-CimInstance Win32_Process | Where-Object { $$_.Name -eq ''node.exe'' -and $$_.ExecutablePath -like ''*Necter*'' } | ForEach-Object { Stop-Process -Id $$_.ProcessId -Force -ErrorAction SilentlyContinue }"'
  Pop $R0
...
!macro customUnInstallCheck
  ${if} $R0 != 0
    Push $R0
    Call NecterShowLegacyUninstallHelp
  ${endif}
!macroend
