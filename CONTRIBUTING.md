# Contributing to Necter

Thank you for your interest in contributing! Necter is an open-source desktop AI agent app built with Electron, React, and TypeScript. This guide covers everything you need to get started.
...
Necter uses **Dependabot** (`.github/dependabot.yml`) to keep dependencies current. To avoid PR pile-up and reduce risk, we follow a tiered strategy:
